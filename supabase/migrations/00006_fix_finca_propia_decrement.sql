-- ============================================
-- Migration 00006: Fix finca_propia decrement
-- The UPDATE in create_entrada set animal_count to 0 before the DELETE
-- could clean it up, violating the animal_count > 0 check constraint.
-- Fix: DELETE rows that would reach 0 first, then UPDATE the rest.
-- ============================================
