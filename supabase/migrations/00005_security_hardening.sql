-- ============================================
-- Migration 00005: Security hardening
-- 1. Add MIME type filtering to aval-documents storage RLS
-- 2. Add origin pool org membership check to create_entrada
-- ============================================

-- 1. Update storage upload policy to restrict accepted MIME types
DROP POLICY IF EXISTS "aval_upload" ON storage.objects;
...
-- 2. Update create_entrada to verify origin pool belongs to caller's org
