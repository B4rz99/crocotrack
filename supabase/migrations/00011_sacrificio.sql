...
CREATE TABLE public.sacrificios (
    ...
    CONSTRAINT chk_sacrificios_totals CHECK (
        total_sacrificed + total_rejected + total_faltantes = total_animals
    ),
    notes            TEXT,
...
CREATE UNIQUE INDEX idx_sacrificio_size_groups_rechazado_unique
...
BEGIN
    ...
    -- en lote_size_compositions. Solo se limita el total de animales (paso 9).
